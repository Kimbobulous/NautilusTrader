...
Reference full template: `C:/dev/nautilustrader/.codex/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `C:/dev/nautilustrader/.codex/get-shit-done/templates/state.md`.
