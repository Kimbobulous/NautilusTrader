...
Use template from `C:/dev/nautilustrader/.codex/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `C:/dev/nautilustrader/.codex/get-shit-done/templates/UI-SPEC.md`
...
```bash
node "C:/dev/nautilustrader/.codex/get-shit-done/bin/gsd-tools.cjs" commit "docs($PHASE): UI design contract" --files "$PHASE_DIR/$PADDED_PHASE-UI-SPEC.md"
```
