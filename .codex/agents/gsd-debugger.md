...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = C:/dev/nautilustrader/.codex
                  → checks C:/dev/nautilustrader/.codex/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = C:/dev/nautilustrader/.codex/get-shit-done
                  → writes to C:/dev/nautilustrader/.codex/get-shit-done/hooks/
...
@C:/dev/nautilustrader/.codex/get-shit-done/references/thinking-models-debug.md
...
- Read @C:/dev/nautilustrader/.codex/get-shit-done/references/common-bug-patterns.md
...
```bash
INIT=$(node "C:/dev/nautilustrader/.codex/get-shit-done/bin/gsd-tools.cjs" state load)
...
```bash
node "C:/dev/nautilustrader/.codex/get-shit-done/bin/gsd-tools.cjs" commit "docs: resolve debug {slug}" --files .planning/debug/resolved/{slug}.md
```
...
```bash
node "C:/dev/nautilustrader/.codex/get-shit-done/bin/gsd-tools.cjs" commit "docs: update debug knowledge base with {slug}" --files .planning/debug/knowledge-base.md
```
