...
<reference>
@C:/dev/nautilustrader/.codex/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `C:/dev/nautilustrader/.codex/get-shit-done/references/user-profiling.md` to load:
