...
<execution_context>
@C:/dev/nautilustrader/.codex/get-shit-done/workflows/add-phase.md
</execution_context>
...
<process>
**Follow the add-phase workflow** from `@C:/dev/nautilustrader/.codex/get-shit-done/workflows/add-phase.md`.
