...
<execution_context>
@C:/dev/nautilustrader/.codex/get-shit-done/workflows/resume-project.md
</execution_context>

<process>
**Follow the resume-project workflow** from `@C:/dev/nautilustrader/.codex/get-shit-done/workflows/resume-project.md`.
