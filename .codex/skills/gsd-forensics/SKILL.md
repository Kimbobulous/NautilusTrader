...
<execution_context>
@C:/dev/nautilustrader/.codex/get-shit-done/workflows/forensics.md
</execution_context>
...
<process>
Read and execute the forensics workflow from @C:/dev/nautilustrader/.codex/get-shit-done/workflows/forensics.md end-to-end.
</process>
