...
<execution_context>
@C:/dev/nautilustrader/.codex/get-shit-done/workflows/settings.md
</execution_context>

<process>
**Follow the settings workflow** from `@C:/dev/nautilustrader/.codex/get-shit-done/workflows/settings.md`.
