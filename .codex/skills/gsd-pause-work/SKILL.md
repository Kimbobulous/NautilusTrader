...
<execution_context>
@C:/dev/nautilustrader/.codex/get-shit-done/workflows/pause-work.md
</execution_context>
...
<process>
**Follow the pause-work workflow** from `@C:/dev/nautilustrader/.codex/get-shit-done/workflows/pause-work.md`.
