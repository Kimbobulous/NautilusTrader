...
<execution_context>
@C:/dev/nautilustrader/.codex/get-shit-done/workflows/check-todos.md
</execution_context>
...
<process>
**Follow the check-todos workflow** from `@C:/dev/nautilustrader/.codex/get-shit-done/workflows/check-todos.md`.
