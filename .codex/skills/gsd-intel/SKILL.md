...
Intel system is disabled. To activate:
  ...
  node C:/dev/nautilustrader/.codex/get-shit-done/bin/gsd-tools.cjs config-set intel.enabled true
...
```bash
node C:/dev/nautilustrader/.codex/get-shit-done/bin/gsd-tools.cjs intel query <term>
```
...
```bash
node C:/dev/nautilustrader/.codex/get-shit-done/bin/gsd-tools.cjs intel status
```
...
```bash
node C:/dev/nautilustrader/.codex/get-shit-done/bin/gsd-tools.cjs intel diff
```
...
Project root: ${CWD}
gsd-tools path: C:/dev/nautilustrader/.codex/get-shit-done/bin/gsd-tools.cjs
