...
<execution_context>
@C:/dev/nautilustrader/.codex/get-shit-done/workflows/update.md
</execution_context>

<process>
**Follow the update workflow** from `@C:/dev/nautilustrader/.codex/get-shit-done/workflows/update.md`.
